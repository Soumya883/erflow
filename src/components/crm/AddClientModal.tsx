...
import { createClient } from "@/app/actions/crm";
        ...
        <form onSubmit={handleSubmit} className="px-6 py-4 space-y-4">
          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <Input name="name" required placeholder="Jane Smith" className="rounded-xl" />
            </div>
            <div className="space-y-2">
              <label className="text-sm font-medium">Company</label>
              <Input name="company" required placeholder="Global Tech" className="rounded-xl" />
            </div>
          </div>

          <div className="space-y-2">
            <label className="text-sm font-medium">Email</label>
            <Input name="email" type="email" required placeholder="jane@globaltech.com" className="rounded-xl" />
          </div>
          ...
          <div className="space-y-2">
            ...
            <Textarea name="address" placeholder="123 Business Rd..." className="rounded-xl" />
          </div>
